...
# From http://stackoverflow.com/questions/7162604/get-cached-credentials-in-powershell-from-windows-7-credential-manager
    $sig = @"
...
"@
    ...
    $success = [ADVAPI32.Util]::CredRead($url,1,0,[ref] $nCredPtr)
    ...
    if ($success) {
        ...
        throw "Credentials not found for $url"
    }
}
